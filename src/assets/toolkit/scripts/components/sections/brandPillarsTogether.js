...
$(document).ready(() => {
  const $section = $('[data-anchor="brandPillarsTogether"]');
  ...
  // title
  var mySplitText = new SplitText($('#brandPillarsTogetherTitle'), { type: 'words, chars' });
  ...
  // diamonds
  var diamond = new TweenMax.staggerTo($diamond, .2, { opacity: '1', autoAlpha: 1, y: '0', yoyo: true, ease: Linear.easeIn, delay: .5 }, 0.1);
