...
$(document).ready(() => {
  const $section = $('[data-anchor="guidingPrinciplesKindling"]');
  ...
  // title
  var mySplitText = new SplitText($('#guidingPrinciplesKindlingTitle'), { type: 'words, chars' });
  ...
  // diamonds
  var diamond = new TweenMax.staggerTo($diamond, .2, { opacity: '1', autoAlpha: 1, y: '0', yoyo: true, ease: Linear.easeIn, delay: .8 }, 0.15);
