...
$(document).ready(() => {
  const $section = $('[data-anchor="logoType"]');
  ...
  // symbol
  var symbol = new TimelineMax().fromTo($symbol, .2, { scale: '1.02', y: '30', opacity: '0' }, { scale: '1', y:'0', opacity: '1', ease: Linear.easeIn, delay: .25 });
