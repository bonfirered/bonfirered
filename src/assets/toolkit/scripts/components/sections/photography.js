...
$(document).ready(() => {
  const $section = $('[data-anchor="photography"]');
  ...
  // cards
  var card = new TweenMax.staggerFromTo($card, .2, {opacity: '0', y:'30', scale: '1.02'}, { opacity: '1', y:'0', scale: '1', autoAlpha: 1, yoyo: true, ease: Linear.easeIn, delay: .35 }, 0.15);
